...
9. **Locally verified, GitHub regression pending:** Projects, documents and metadata (0.14.0), 15 new tools and expanded record operations; 144 tools total.
10. **Locally verified, release preparation:** Virtual collections (0.15.0), eight new tools; 152 tools total. Modules 11–13 remain pending in roadmap order.
...
### 0.14.0 — Projects, documents and metadata (release validation)
